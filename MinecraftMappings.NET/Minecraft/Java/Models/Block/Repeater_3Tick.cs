...
{
    public class Repeater_3Tick : JavaBlockModel
    {
        public Repeater_3Tick() : base("Repeater, 3 Tick")
        {
            AddVersion("repeater_3tick", "1.5")
                ...
                .AddElement(element => {
                    element.From = new Vector3(7f, 2f, 10f);
                    element.To = new Vector3(9f, 7f, 12f);
