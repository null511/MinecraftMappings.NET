...
{
    public class Repeater_1TickOn : JavaBlockModel
    {
        public Repeater_1TickOn() : base("Repeater, 1 Tick On")
        {
            AddVersion("repeater_1tick_on", "1.5")
                ...
                .AddElement(element => {
                    element.From = new Vector3(7f, 7f, 6f);
                ...
                .AddElement(element => {
                    element.From = new Vector3(7f, 2f, 5f);
                    element.To = new Vector3(9f, 8f, 9f);
                ...
                .AddElement(element => {
                    element.From = new Vector3(6f, 2f, 6f);
                    element.To = new Vector3(10f, 8f, 8f);
