...
{
    public class Stem_Growth6 : JavaBlockModel
    {
        public Stem_Growth6() : base("Stem, Growth 6")
        {
            AddVersion("stem_growth6", "1.0.0")
                .WithPath("models/block")
                .AddElement(element => {
                    element.From = new Vector3(0f, -1f, 8f);
                    element.To = new Vector3(16f, 13f, 8f);
                    ...
                    element.FaceNorth = new ModelFace {
                        UV = UVMap(0f, 0f, 16f, 14f),
                        Texture = "#stem",
                    };
                    element.FaceSouth = new ModelFace {
                        UV = UVMap(16f, 0f, 0f, 14f),
                        Texture = "#stem",
                    };
                })
                .AddElement(element => {
                    element.From = new Vector3(8f, -1f, 0f);
                    element.To = new Vector3(8f, 13f, 16f);
                    element.Rotation = new ModelElementRotation {
                        Origin = new Vector3(8f, 8f, 8f),
                        Axis = ModelAxis.Y,
                        Angle = 45,
