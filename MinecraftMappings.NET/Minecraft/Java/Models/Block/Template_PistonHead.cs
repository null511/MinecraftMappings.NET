...
{
    public class Template_PistonHead : JavaBlockModel
    {
        public Template_PistonHead() : base("Template Piston Head")
        {
            AddVersion("template_piston_head", "1.3.1")
                ...
                .AddElement(element => {
                    ...
                    element.To = new Vector3(10f, 10f, 20f);
                    element.FaceUp = new ModelFace("#side") {
                        UV = UVMap(0f, 0f, 16f, 4f),
                        Rotation = 270,
                    };
