...
{
    public class Template_CauldronLevel2 : JavaBlockModel
    {
        public Template_CauldronLevel2() : base("Template Cauldron, Level 2")
        {
            AddVersion("template_cauldron_level2", "1.0.0")
                ...
                .AddElement(element => {
                    ...
                    element.To = new Vector3(14f, 12f, 14f);
