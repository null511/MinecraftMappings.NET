...
{
    public class DirtPathOverlay : JavaBlockModel
    {
        public DirtPathOverlay() : base("Dirt Path, Overlay")
        {
            AddVersion("dirt_path_overlay", "1.17")
                .WithPath("models/block")
                .WithParent("block/block")
                .AddTexture("top", "block/dirt_path_top")
                .AddTexture("dirt", "block/dirt")
                .AddTexture("overlay", "block/dirt_path_side_overlay")
                .AddElement(element => {
