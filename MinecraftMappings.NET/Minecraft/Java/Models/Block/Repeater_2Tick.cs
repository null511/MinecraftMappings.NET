...
{
    public class Repeater_2Tick : JavaBlockModel
    {
        public Repeater_2Tick() : base("Repeater, 2 Tick")
        {
            AddVersion("repeater_2tick", "1.5")
                ...
                .AddElement(element => {
                    element.From = new Vector3(7f, 2f, 8f);
                    element.To = new Vector3(9f, 7f, 10f);
